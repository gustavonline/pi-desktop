...
- [x] Issue/milestone hygiene pass complete: closed v1 tracker/items (`#99`, `#96`), consolidated active scope under `#21` + milestone `v2 backlog`, and closed completed milestones (`v1.0 stable`, `v1.1 UX polish`, `Canvas mode foundation`).
